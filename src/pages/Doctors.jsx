...
export default function DoctorsMain() {
  ...
  const hnadlePriceChange = (e) => {
    setSearch({ ...search, min: e.target.value.split(",")[0], max: e.target.value.split(",")[1] });
  };
  ...
  return (
    <div>
     ...
     {
      filterVisible? <Box p="5px" background="#FA6B6C">
      <SimpleGrid w={["90%", "80%", "70%"]} m="auto" columns={2} spacing={4}>
        <Select
