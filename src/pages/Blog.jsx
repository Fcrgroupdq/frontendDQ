        ...
        <img class="w-full my-0 object-fill" src={hospitaldent} alt="List of Top 5 Best Hospital in Delhi- Find the Best" />
          <div class="p-6">
            ...
            <div class="flex items-center flex-wrap ">
              <a href='https://www.doctorsqueries.com/list-of-top-5-best-hospital-in-delhi' class="text-indigo-500 hover:text-violet-500 inline-flex items-center md:mb-2 lg:mb-0">Read More
