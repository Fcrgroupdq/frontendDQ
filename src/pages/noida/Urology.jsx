...
function NoidaUrology() {
    ...
    return (
      ...
      <div>
          <Helmet>
          <meta charSet="utf-8" />
          <title>Urology in Noida | Doctors Queries</title>
          <meta
              name="description"
          ...
          />
          <link rel="canonical" href="https://www.doctorsqueries.com/Urology-in-Noida" />
          <meta
              name="keywords"
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Urology in Noida</h1>
