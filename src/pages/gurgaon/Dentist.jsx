...
function GurgaonDentist() {
  const [doctors, setDoctors] = useState([]);

  useEffect(() => {
    axios
      .get(
        `https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${"dentist"}&status=approved&query=${"Gurgaon"}`
      )
      .then((res) => {
        setDoctors(res.data);
      });
  ...
  return (
    <>
      ...
      <div>
        <Helmet>
          <meta charSet="utf-8" />
          <title>Dentist in Gurgaon | Doctors Queries</title>
          <meta
            name="description"
  ...
  <div class="container px-3 py-12 mx-auto">
    <div class="flex flex-col text-center w-full mb-6">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Dentist in Gurgaon</h1>
