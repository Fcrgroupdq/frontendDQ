...
function GurgaonHairTransplant() {

    const [doctors,setDoctors] = useState([]);

    useEffect(()=>{
        axios.get(`https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${'hairtransplant'}&status=approved&query=${'Gurgaon'}`)
        .then(res => {
           setDoctors(res.data)
        })
    },[])
    ...
    return (
      ...
      <div>
          <Helmet>
          <meta charSet="utf-8" />
          <title>HairTransplant in Gurgaon | Doctors Queries</title>
          <meta
              name="description"
          ...
          />
          <link rel="canonical" href="https://www.doctorsqueries.com/HairTransplant-in-Gurgaon" />
          <meta
              name="keywords"
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best HairTransplant in Gurgaon</h1>
...
export default GurgaonHairTransplant;
