...
function GurgaonOrthopedic() {

    const [doctors,setDoctors] = useState([]);

    useEffect(()=>{
        axios.get(`https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${'orthopedic'}&status=approved&query=${'Gurgaon'}`)
        .then(res => {
           setDoctors(res.data)
        })
    },[])
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Orthopedic in Gurgaon</h1>
...
export default GurgaonOrthopedic;
