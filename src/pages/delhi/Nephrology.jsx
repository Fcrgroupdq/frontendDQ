...
function Nephrology() {
    ...
    useEffect(()=>{
        axios.get(`https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${'nephrology'}&status=approved&query=${'delhi'}`)
        .then(res => {
           setDoctors(res.data)
        })
    },[])
    ...
    return (
      ...
      <div>
          <Helmet>
          <meta charSet="utf-8" />
          <title>Best Nephrologist in Delhi - Updated List 2024</title>
          <meta
              name="description"
              content="Find the best nephrologist in Delhi with our updated list for 2024. Trust DoctorsQueries to help you find the top specialists for your kidney health needs."
          />
          <link rel="canonical" href="https://www.doctorsqueries.com/delhi/nephrologist-in-delhi" />
          <meta
              name="keywords"
              content=" nephrologist in Delhi, best nephrologist in Delhi, nephrologist doctor in Delhi, best nephrologist doctor in Delhi"
          />
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Nephrologist in Delhi - Updated List 2024</h1>
