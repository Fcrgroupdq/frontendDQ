...
function NeuroSurgeon() {
    ...
    useEffect(()=>{
        axios.get(`https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${'neurosurgeon'}&status=approved&query=${'delhi'}`)
        .then(res => {
           setDoctors(res.data)
        })
    },[])
    ...
    return (
      ...
      <div>
          <Helmet>
          <meta charSet="utf-8" />
          <title>Best Neuro Surgeon in Delhi - DoctorsQueries</title>
          <meta
              name="description"
              content="Looking for the best neuro surgeon in Delhi? Look no further than DoctorsQueries, where you can find the top neurosurgeons in the city."
          />
          <link rel="canonical" href="https://www.doctorsqueries.com/delhi/neuro-surgeon-in-delhi" />
          <meta
              name="keywords"
              content="neuro surgeon in Delhi, best neuro surgeon in Delhi, neuro surgeon doctor in Delhi, best neuro surgeon doctor in Delhi"
          />
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Neuro Surgeon in Delhi</h1>
