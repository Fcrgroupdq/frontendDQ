...
function Ophthalmology() {
    ...
    useEffect(()=>{
        axios.get(`https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${'ophthalmology'}&status=approved&query=${'delhi'}`)
        .then(res => {
           setDoctors(res.data)
        })
    },[])
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Ophthalmology in Delhi</h1>
