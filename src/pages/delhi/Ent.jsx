...
function Ent() {
    ...
    useEffect(()=>{
        axios.get(`https://drab-blue-mite-belt.cyclic.app/doctors/doctors/near/?cat=${'ent'}&status=approved&query=${'delhi'}`)
        .then(res => {
           setDoctors(res.data)
        })
    },[])
    ...
    return (
      ...
      <div>
          <Helmet>
          <meta charSet="utf-8" />
          <title>Best Ent Specialist Doctors in Delhi - DoctorsQueries</title>
          <meta
              name="description"
              content="Get expert treatment from the best ENT specialist doctors in Delhi at DoctorsQueries. Schedule an appointment today."
          />
          <link rel="canonical" href="https://www.doctorsqueries.com/delhi/ent-specialist-doctors-in-delhi" />
          <meta
              name="keywords"
              content="ENT specialist doctors in Delhi, best ENT specialist doctors in Delhi, ENT specialist in Delhi, best ENT specialist in Delhi"
          />
  ...
  <div class="container px-3 py-12 mx-auto">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-900">Best Ent Specialist in Delhi</h1>
