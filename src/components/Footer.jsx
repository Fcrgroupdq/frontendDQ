...
" />
  ...
  <div class="container mx-auto px-5 py-24">
    <div class="-mx-4 -mb-10 flex flex-wrap text-left md:text-left">
      <div class="w-full px-4 md:w-1/2 lg:w-1/4">
        <h2 class="title-font mb-3 text-sm font-medium tracking-widest text-gray-900">CATEGORIES</h2>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto flex flex-col flex-wrap px-5 py-4 sm:flex-row">
      ...
      <span class="mt-2 w-full text-center text-sm text-gray-500 sm:ml-auto sm:mt-0 sm:w-auto sm:text-left">Enamel pin tousled raclette tacos irony</span>
    </div>
  </div>
</footer>
