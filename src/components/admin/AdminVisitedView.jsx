...
const AdminVisitedView = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://drab-blue-mite-belt.cyclic.app/appointment?status=visited`
      )
  ...
  return (
    <div>
      ...
      <Heading as="h2" size="xl" mt={6} mb={2}>
        {`Total ${userAppointment.length} appointment are visited`}
      </Heading>
      <Text color={'gray.500'}>
      See all Visited appointment details on below the page.
      </Text>
    </Box>
...
export default AdminVisitedView;
