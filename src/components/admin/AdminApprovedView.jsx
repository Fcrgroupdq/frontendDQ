...
const AdminApprovedView = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://drab-blue-mite-belt.cyclic.app/appointment?status=approved`
      )
    ...
    <div>
      <Box textAlign="center" py={10} px={6}>
          ...
          <Heading as="h2" size="xl" mt={6} mb={2}>
            {`Total ${userAppointment.length} appointment is approved now`}
          </Heading>
          <Text>See all approved appointment details on below the page</Text>
        </Box>
